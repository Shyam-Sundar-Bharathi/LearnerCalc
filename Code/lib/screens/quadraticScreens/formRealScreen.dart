...
class _quadraticFormRealState extends State<quadraticFormReal> {
  ...
  String result = " ";
  TextEditingController rootOne = new TextEditingController();
  TextEditingController rootTwo = new TextEditingController();
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    myQuadraticTextField(rootOne),
                    SizedBox(width: 10,),
                    myQuadraticText("Root 2 : "),
                    myQuadraticTextField(rootTwo, lastBox: true),
                  ],
                ),
                SizedBox(height: 20,),
                ElevatedButton(
                  ...
                  onPressed: () {
                    FocusScope.of(context).requestFocus(FocusNode());
                    setState(() {
                      result = equation(rootOne.text, rootTwo.text);
                    });
                  },
                  child: FittedBox(
                    child: Text(
